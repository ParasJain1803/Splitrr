...
const GroupItem = ({
  ...
  <Link href={`/group/${id}`}>
    <div className="flex items-center space-x-4 p-4 bg-gray-900/80 rounded-lg shadow mb-4">
      {" "}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-emerald-900 text-gray-300">
      <div className="max-w-2xl mx-auto p-4">
        <h1 className="text-3xl font-bold mb-4 text-white">Your Groups</h1>
        ...
        <Link href="/group">
          <Button className="mt-6 bg-emerald-600 hover:bg-emerald-700 text-white flex items-center justify-center p-4 rounded-lg shadow mb-4">
            {" "}
            {/* Added margin-bottom for spacing */}
