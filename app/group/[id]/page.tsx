  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-emerald-900 text-gray-300">
      <div className="p-6 max-w-4xl mx-auto">
        ...
        <p className="text-gray-300 mb-8">{groupDescription}</p>
        <h2 className="text-2xl font-semibold mb-4 text-white">Balances</h2>
        {balances.length > 0 ? (
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg mb-8">
            {balances.map((balance, index) => (
              <Card key={index} className="mb-4">
                <CardContent className="flex items-center p-4 bg-gray-800">
                  <div
        ...
        <h2 className="text-2xl font-semibold mb-4 text-white">Expenses</h2>
        {expenses.length > 0 ? (
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            {expenses.map((expense) => (
              <Card key={expense.id} className="mb-4">
                <CardContent className="flex items-center justify-between p-4 bg-gray-800">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400">
                        ...
                        {(
                          (expense.split_with[0]?.splitAmount /
                            expense.amount) *
                          100
                        ).toFixed(2)}
                        %
